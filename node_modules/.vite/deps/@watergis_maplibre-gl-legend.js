...
var vr = class _vr {
  ...
  static parse(e, t) {
    ...
    const n = e[1];
    return t.scope.has(n) ? new _vr(n, t.scope.get(n)) : t.error(`Unknown variable "${n}". Make sure "${n}" has been bound in an enclosing "let" expression before using it.`, 1);
  }
  evaluate(e) {
...
var ot = class _ot {
  ...
  static parse(e, t) {
    ...
    return l.kind !== "number" && l.kind !== "color" && !(l.kind === "array" && l.itemType.kind === "number" && typeof l.N == "number") ? t.error(`Type ${L(l)} is not interpolatable.`) : new _ot(l, n, i, o, s);
  }
  evaluate(e) {
    const t = this.labels, n = this.outputs;
    if (t.length === 1)
    ...
    if (i >= t[o - 1])
      return n[o - 1].evaluate(e);
    const a = yt(t, i), s = t[a], l = t[a + 1], u = _ot.interpolationFactor(this.interpolation, i, s, l), c = n[a].evaluate(e), p = n[a + 1].evaluate(e);
...
var Tr = class _Tr {
  ...
  static parse(e, t) {
    ...
    return !n || !i ? null : sr(n.type, [
      ...
      ct,
      C
    ]) ? new _Tr(n, i) : t.error(`Expected first argument to be of type boolean, string, number or null, but found ${L(n.type)} instead`);
  }
  evaluate(e) {
...
var zr = class _zr {
  ...
  static parse(e, t) {
    ...
    return !l || s.type.kind !== "value" && t.concat(1).checkSubtype(n, s.type) ? null : new _zr(n, i, s, o, a, l);
  }
  evaluate(e) {
...
var Er = class _Er {
  ...
  static parse(e, t) {
    ...
    if (i["min-fraction-digits"] && (l = t.parse(i["min-fraction-digits"], 1, y), !l))
      return null;
    let u = null;
    return i["max-fraction-digits"] && (u = t.parse(i["max-fraction-digits"], 1, y), !u) ? null : new _Er(n, o, a, s, l, u);
  }
  evaluate(e) {
...
var Ar = class _Ar {
  ...
  static parse(e, t) {
    ...
    return n ? n.type.kind !== "array" && n.type.kind !== "string" && n.type.kind !== "value" ? t.error(`Expected argument of type string or array, but found ${L(n.type)} instead.`) : new _Ar(n) : null;
  }
  evaluate(e) {
    const t = this.input.evaluate(e);
    if (typeof t == "string")
    ...
    /* @__PURE__ */ function() {
      return {
        write: function(n, i, o, a, s, l) {
          var u = [];
          u.push(n + "=" + encodeURIComponent(i)), r.isNumber(o) && u.push("expires=" + new Date(o).toGMTString()), r.isString(a) && u.push("path=" + a), r.isString(s) && u.push("domain=" + s), l === true && u.push("secure"), document.cookie = u.join("; ");
        },
        read: function(n) {
...
*/
//# sourceMappingURL=@watergis_maplibre-gl-legend.js.map
